...
export default function OrganizerLogin() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <section className="flex flex-col justify-between bg-slate-900 bg-[url('https://i.pinimg.com/736x/1b/37/ef/1b37eff4dac593be6f005781b1dd8188.jpg')] bg-cover bg-center px-12 py-10 text-white">
        <div>
          <p className="text-xs uppercase tracking-[0.35em] text-white/70">QEICS</p>
        ...
        <div className="rounded-3xl bg-white/10 p-6 text-white backdrop-blur">
          <p className="text-lg font-semibold">“I set up an Iftar gathering and community meetup in one weekend.”</p>
          <p className="mt-3 text-sm text-white/80">Sadiq · Creator & Host</p>
        </div>
      </section>
